% MEDConvertCSV - Function for converting data from a med file to d-space
% vs. relative intensitites with output to a CSV file.
% Last updated: June 5, 2015
% Code written by Matthew L. Whitaker
function [file,data] = MEDConvertCSV(filename)
...
textname=strcat(path,filesep,file,{'.txt'});
